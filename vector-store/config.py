...
# OSINT Agent
OSINT_COOLDOWN_SECONDS = int(os.getenv("OSINT_COOLDOWN_SECONDS", "300"))
OSINT_MAX_WEB_RESULTS = int(os.getenv("OSINT_MAX_WEB_RESULTS", "10"))
OSINT_MAX_NEWS_RESULTS = int(os.getenv("OSINT_MAX_NEWS_RESULTS", "10"))
